...
{
    public class RuminoidMetro : IStyle, IResourceProvider
    {
        private readonly Uri _baseUri;
        private IStyle[] _loaded;
        private bool _isLoading;

        public RuminoidMetro(Uri baseUri)
        {
            _baseUri = baseUri;
        }

        public RuminoidMetro(IServiceProvider serviceProvider)
        {
        ...
        public IStyle Loaded
        {
            get
            {
                if (_loaded != null) return _loaded?[0]!;
